...
import nl.agentsatwork.attribute.DefaultAttribute;
import nl.agentsatwork.collection.AbstractIterator;
import nl.agentsatwork.collection.AbstractSet;

abstract public class AbstractAttributes extends AbstractImmutableAttributes
		implements Attributes {

	public void set(String name, String value) {
		Attribute attribute = attribute(name);
		if (attribute == null) {
			attribute = new DefaultAttribute(this, name);
